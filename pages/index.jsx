      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1 }} className="max-w-3xl">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="mt-4 text-lg text-gray-600">
            Перевод сообщений в реальном времени.<br/>Общайтесь без языковых барьеров — просто говорите, а бот всё переведёт.
          </p>
        </div>
        ...
        <div className="mt-10 flex justify-center space-x-6 text-gray-500">
          ...
          <a href="https://github.com/chatbridge-ai/chatbridge-ai-landing" target="_blank" className="hover:text-blue-600">GitHub</a>
        </div>
      </motion.div>
    </div>
  );
